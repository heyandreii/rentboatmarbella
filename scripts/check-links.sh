...
# del blog (ES/EN/FR/RU/IT/NL), añadiendo un cache-buster (?cb=...) para NO validar
...
INDEXES=(blog-nautico-marbella.html yacht-blog.html blog-nautique.html morskoy-blog.html blog-nautica-marbella.html vaarblog-marbella.html)
